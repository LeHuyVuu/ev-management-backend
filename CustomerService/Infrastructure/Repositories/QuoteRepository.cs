...
public class QuoteRepository
{
    ...
    public async Task<Quote> GetQuoteByContractId(Guid contractId)
    {
        return await _dbContext.Quotes.FirstOrDefaultAsync(q => q.Contracts.Any(c => c.ContractId == contractId));
    }
}